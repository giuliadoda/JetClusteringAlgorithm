...
if __name__ == "__main__":
    ...
    for i in range(len(schedules)):
        ...
        y = df['avg_exec_time'] / 60      # minutes, consistent with t1_i
        y_speedup = t1_i / y
    ...
    # removed the old fixed ylim(0, 0.15) patch that was masking the unit-mismatch bug;
    # let matplotlib auto-scale, or set sensible bounds once the data looks right, e.g.:
    # ax_su.set_ylim(0, threads[-1] * 1.1)
